...
OUT_DIR_MC = Path().resolve() / "Monte_Carlo_Outputs" / "RLSSA_MC_classic_vs_riskadjusted"
...
def run_monte_carlo_both(n_runs=MC_RUNS, save_series=SAVE_SERIES, zero_noise=ZERO_NOISE):
    ...
    with redirect_stdout(tee):
        ...
        export_run_returns_and_plot(
            ...
            tracking_dir,
            "long_classic",
            f"RLSSA Monte Carlo | Long Classic | Cumulative value paths ({n_runs} runs)",
            "tab:green",
        )
        export_run_returns_and_plot(
            ...
            tracking_dir,
            "long_risk_adjusted",
            f"RLSSA Monte Carlo | Long Risk-adjusted | Cumulative value paths ({n_runs} runs)",
            "tab:blue",
        )
        export_run_returns_and_plot(
            ...
            tracking_dir,
            "short_classic",
            f"RLSSA Monte Carlo | Short Classic | Cumulative value paths ({n_runs} runs)",
            "tab:red",
        )
        export_run_returns_and_plot(
            ...
            tracking_dir,
            "short_risk_adjusted",
            f"RLSSA Monte Carlo | Short Risk-adjusted | Cumulative value paths ({n_runs} runs)",
            "tab:orange",
        )
        export_run_returns_and_plot(
            ...
            tracking_dir,
            "benchmark",
            f"RLSSA Monte Carlo | Equal-weight benchmark | Cumulative value paths ({n_runs} runs)",
            "tab:gray",
        )
